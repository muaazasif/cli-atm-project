...
async function askForReceipt(withdrawAmt: number, remainingBalance: number, transactionType: string) {
...
function printReceiptMessage(withdrawAmt: number, remainingBalance: number, transactionType: string) {
  const now = moment();
